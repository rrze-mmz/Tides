...
@section('content')
    <main class="sm:container sm:mx-auto sm:max-w-lg sm:mt-10 pt-4">
        <div class="flex pt-10">
            <div class="w-full">
                <section
                    class="flex flex-col pb-10 break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="username" type="text"
                                   class="border-blue-400 w-full rounded-md py-1 @error('username') border-red-500 @enderror"
                                   name="username"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password" type="password"
                                   class="border-blue-400 w-full rounded-md py-1 w-full @error('password') border-red-500 @enderror"
                                   name="password"
                                   required>
                        ...
                        <div class="flex items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-sm text-blue-500 hover:text-blue-700 whitespace-no-wrap no-underline
