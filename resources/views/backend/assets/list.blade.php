...
<div class="flex">
    <ul class="w-full pt-3">
        <li class="mb-4 flex content-center items-center rounded bg-gray-400 p-5 text-center dark:bg-gray-800
            dark:border-white dark:text-white">
            <div class="w-4/12 border-b border-black pb-2 dark:border-white">Saved path</div>
            <div class="w-2/12 border-b border-black pb-2 dark:border-white">File Name</div>
        ...
        @forelse($assets->sortByDesc('height') as $asset)
            <li class="mb-4 flex content-center items-center rounded bg-gray-200 p-2 text-center text-sm
                ...
                <div class="w-2/12"> {{ $asset->original_file_name }}</div>
