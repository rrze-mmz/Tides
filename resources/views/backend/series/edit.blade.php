    ...
    <div class="pt-10 w-full lg:flex-grow lg:mx-10">
        ...
        <div class="flex justify-center content-center content-between py-2 px-2">
            ...
            <div class="flex items-center pt-3 space-x-6">
                <button  class="ml-2 focus:outline-none text-white text-sm py-1.5 px-5 rounded-md bg-blue-900 hover:bg-blue-600 hover:shadow-lg">
                    Add new clip
                </button>
                ...
                <form  action="{{$series->adminPath()}}"
                    ...
                    @csrf
                    @method('DELETE')
                    <button  class="ml-2 focus:outline-none text-white text-sm py-1.5 px-5 rounded-md bg-red-900 hover:bg-red-600 hover:shadow-lg">
                        Delete Series
                    </button>
                </form>
            </div>
