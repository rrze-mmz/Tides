<div class="my-8 space-y-10">
    @if (Session::has('success_message'))
        <div class="rounded-md bg-green-200 p-4 my-8">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm leading-5 font-medium text-green-800">
                        {{ Session::get('success_message', 'default') }}
                    </p>
                </div>
    ...
    <form action="{{ route('clip.comments.store', $clip) }}" method="POST" class="w-1/2 my-12">
        @csrf
        <div class="flex">
            <img class="h-10 w-10 rounded-full" src="https://www.gravatar.com/avatar/?d=mp&f=y" alt="avatar">
            <div class="ml-4 flex-1">
                <textarea  name="content" id="content" rows="4" placeholder="Type your comment here..."
