            ...
            <li>
                <a href="{{ route('frontend.userSettings.edit') }}"
                   class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg
                    ...
                    <x-heroicon-o-adjustments-horizontal class="flex-shrink-0 w-6 h-6 text-gray-500 transition
            ...
            <li>
                <a href="{{ route('frontend.user.comments') }}"
                   class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg
                                   dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                    <x-heroicon-o-chat-bubble-oval-left class="flex-shrink-0 w-6 h-6 text-gray-500 transition
