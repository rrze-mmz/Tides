    ...
    <section class="dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-lg text-center mb-8 lg:mb-16">
                ...
                <p class="font-light text-gray-300 lg:mb-16 sm:text-xl dark:text-gray-400">
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-4 grid-cols-2">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class=" max-w-fit w-48  rounded-lg sm:rounded-none sm:rounded-l-lg"
                             src="https://www.fau.de/files/2024/03/Logo-Feldforschung-quadratisch-1024x1024.jpg"
                             alt="Jese Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Podcasts von Studierenden, Lehrstühlen und der Uni-Leitung</a>
                        </h3>
                        <span
                            class="text-gray-500 dark:text-gray-400"
                        >
                            last episode at {{ Carbon::now()->subMinutes(120) }}
                        </span>
