    ...
    <form method="GET" action="{{ route('search') }}" class="w-full px-4 sm:px-0 lg:w-3/5">
        <div class="p-4">
            <div class="flex flex-col items-center rounded bg-gray-50 dark:bg-slate-800 dark:border-white shadow-xl">
                <!-- Input Field -->
                <div class="flex w-full flex-col p-2 mt-4">
                ...
                <div class="flex flex-wrap justify-between gap-2 px-4 py-2 w-full items-center">
                    <div class="flex md:flex-row sm:flex-col space-x-4">
