        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            <div class="flex justify-between flex-1 sm:hidden">
                ...
                <span>
                    ...
                    @else
                        <span
                                class="relative inline-flex items-center px-4 py-2 ml-3 text-sm
                            font-medium text-gray-500 bg-white border border-gray-300 cursor-default
                             dark:bg-gray-900 dark:border-gray-100 dark:text-white
                            leading-5 rounded-md select-none">
                            {!! __('pagination.next') !!}
                        </span>
                    @endif
                </span>
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700 leading-5 dark:text-white">
                        {!! __('pagination.Showing x to y of xy results', [
                            ...
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                                    <span
                                        ...
                                        text-gray-500 bg-white border dark:bg-gray-900 border-gray-300 dark:text-white
                                        dark:border-gray-100 cursor-default rounded-l-md leading-5"
                                            aria-hidden="true">
                                        <svg class="w-5 h-5 dark:text-white" fill="currentColor"
                                             viewBox="0 0 20 20">
                            ...
                            @if (is_string($element))
                                <span aria-disabled="true">
                                    <span
                                        ...
                                        dark:bg-gray-900 dark:border-gray-100 dark:text-white
                                        text-gray-700 bg-white border border-gray-300 cursor-default leading-5
                                         select-none"
                                    >{{ $element }}
                                    </span>
                                </span>
                                        ...
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span
                                                    ...
                                                    dark:bg-gray-900 dark:border-gray-100 dark:text-white
                                                    border-gray-300 cursor-default leading-5 select-none">
                                                    {{ $page }}
                                                </span>
                                            </span>
                                        @else
