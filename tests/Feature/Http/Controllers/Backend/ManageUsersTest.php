...
class ManageUsersTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->signInRole(EnumRole::ADMIN);
    }
    ...
    public function a_moderator_is_not_allowed_to_view_users_index_page(): void
    {
        ...
        $this->signInRole(EnumRole::MODERATOR);
    ...
    {
        $this->signInRole(EnumRole::SUPERADMIN);
    ...
    {
        $moderator = $this->signInRole(EnumRole::MODERATOR);
        $admin = $this->signInRole(EnumRole::ADMIN);
        $superadmin = $this->signInRole(EnumRole::SUPERADMIN);
    ...
    {
        $clip = ClipFactory::ownedBy($adminA = $this->signInRole(EnumRole::ADMIN))->create();
